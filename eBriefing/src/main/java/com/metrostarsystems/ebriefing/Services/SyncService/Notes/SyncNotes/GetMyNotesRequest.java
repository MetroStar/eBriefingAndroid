...
public class GetMyNotesRequest extends AbstractSoapRequest {

	public GetMyNotesRequest(ServerConnection connection, String bookId) {
		super(connection, ServerConnectionRequest.REQUEST_SYNC_GET_MY_NOTES);

        addPropertyString(Tags.SYNC_GET_MY_NOTES_REQUEST_BOOK_ID, bookId);
	}
