 ...
 */
public class GetNotesUpdatesObject extends AbstractSyncObject<GetNoteUpdateObject> {

    private static final String TAG = GetNotesUpdatesObject.class.getSimpleName();
    ...
    public GetNotesUpdatesObject(boolean valid) {
        super(valid);
    }

    private GetNotesUpdatesObject(Builder build) {
        mObjects = build.mObjects;
    }



    public static class Builder extends AbstractSyncObject.Builder<GetNoteUpdateObject> {
        ...
        public Builder generate(ServerConnection connection, SoapObject object) {
            ...
            if(count > 0) {
                ...
                if(mObjects == null) {
                    mObjects = new ArrayList<GetNoteUpdateObject>();
                }
...
//            SoapObject note = (SoapObject) object.getProperty(Tags.MULTINOTES_GET_NOTES_UPDATES_RESPONSE_NOTE);

            String note_id =
                    object.getPrimitiveProperty(Tags.MULTINOTES_GET_NOTES_UPDATES_RESPONSE_NOTE_ID).toString();

            String book_id =
                    object.getPrimitiveProperty(Tags.MULTINOTES_GET_NOTES_UPDATES_RESPONSE_BOOK_ID).toString();
            ...
            try {
                book_version = Integer.valueOf(
                        object.getProperty(Tags.MULTINOTES_GET_NOTES_UPDATES_RESPONSE_BOOK_VERSION).toString());

                is_deleted = Boolean.valueOf(
                        object.getProperty(Tags.MULTINOTES_GET_NOTES_UPDATES_RESPONSE_IS_DELETED).toString());
            } catch (Exception e) {
                e.printStackTrace();
            }

            String page_id =
                    object.getPrimitiveProperty(Tags.MULTINOTES_GET_NOTES_UPDATES_RESPONSE_PAGE_ID).toString();

            String date_created =
                    object.getPrimitiveProperty(Tags.MULTINOTES_GET_NOTES_UPDATES_RESPONSE_DATE_CREATED).toString();

            String date_modified =
                    object.getPrimitiveProperty(Tags.MULTINOTES_GET_NOTES_UPDATES_RESPONSE_DATE_MODIFIED).toString();

            String text =
                    object.getPrimitiveProperty(Tags.MULTINOTES_GET_NOTES_UPDATES_RESPONSE_NOTE_TEXT).toString();
            ...
            mObjects.add(new GetNoteUpdateObject.Builder()
                                    .noteId(note_id)
                                    .bookId(book_id)
        ...
        @Override
        public GetNotesUpdatesObject build() {
            return new GetNotesUpdatesObject(this);
        }
    }



    public static class GetNoteUpdateObject {
        ...
        public GetNoteUpdateObject(Builder build) {
        ...
        public static class Builder {
            ...
            public GetNoteUpdateObject build() {
                return new GetNoteUpdateObject(this);
            }
        }
    }
}
