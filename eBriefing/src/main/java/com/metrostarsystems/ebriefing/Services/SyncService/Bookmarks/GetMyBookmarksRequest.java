...
public class GetMyBookmarksRequest extends AbstractSoapRequest {

	public GetMyBookmarksRequest(ServerConnection connection, String bookId) {
		super(connection, ServerConnectionRequest.REQUEST_SYNC_GET_MY_BOOKMARKS);

        addPropertyString(Tags.SYNC_GET_MY_BOOKMARKS_REQUEST_BOOK_ID, bookId);
	}
