...
public abstract class AbstractSyncObject<T> {

	protected ArrayList<T>	mObjects = new ArrayList<T>();
	private boolean			mValid = false;
	
	public AbstractSyncObject() {
		
	}
	
	public AbstractSyncObject(boolean valid) {
		mValid = valid;
	}
	...
	public boolean isValid() { return mObjects != null && mObjects.size() > 0 || mValid; }
	...
	public abstract static class Builder<T> {
		...
		public abstract AbstractSyncObject<T> build();
