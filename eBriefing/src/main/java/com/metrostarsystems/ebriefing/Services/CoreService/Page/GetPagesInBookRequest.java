...
package com.metrostarsystems.ebriefing.Services.CoreService.Page;
...
public class GetPagesInBookRequest extends AbstractSoapRequest {

	public GetPagesInBookRequest(ServerConnection connection) {
		super(connection, ServerConnectionRequest.REQUEST_CORE_GET_PAGES);
	}
